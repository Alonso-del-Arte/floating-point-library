...
// octuple
    ...
    public boolean isNormal() {
        ...
        return masked > 1023 && masked < 31744;
    }
    
    @Override
    public boolean isSubnormal() {
        return (this.heldShort & Short.MAX_VALUE) < 1024;
    }
    
    @Override
    public boolean isZero() {
        return (this.heldShort | Short.MIN_VALUE) == Short.MIN_VALUE;
    }
    
    // TODO: Write tests for this
    @Override
    public boolean isInteger() {
        if ((this.heldShort > -17407 && this.heldShort < -1024) 
                || (this.heldShort > 16383 && this.heldShort < 31744)) {
            return true;
        }
        int abs = this.heldShort & Short.MAX_VALUE;
        return abs == 0 || abs == 15360;
    }
