...
//        for (short sh )
    ...
    @Test
    public void testNegativeInfinityIsNotZero() {
        short sh = -1024;
        FloatingPointNumber infinity = new HalfPrecisionNumber(sh);
        String msg = infinity.toString() + " should not be zero";
        assert !infinity.isZero() : msg;
    }
    
    @Test
    public void testNegativeNaNIsNotZero() {
        String msgPartA = " from bit pattern ";
        String msgPartB = " should not be zero";
        for (short sh = -1023; sh < 0; sh++) {
            FloatingPointNumber instance = new HalfPrecisionNumber(sh);
    ...
    @Test
    public void testPositiveInfinityIsNotZero() {
        short sh = 31744;
        FloatingPointNumber infinity = new HalfPrecisionNumber(sh);
        String msg = infinity.toString() + " should not be zero";
        assert !infinity.isZero() : msg;
    ...
    @Test
    public void testPositiveNaNIsNotZero() {
        String msgPartA = " from bit pattern ";
        String msgPartB = " should not be zero";
        for (short sh = 31745; sh > 0; sh++) {
            FloatingPointNumber instance = new HalfPrecisionNumber(sh);
            String msg = instance.toString() + msgPartA 
                    + Integer.toHexString(sh) + msgPartB;
            assert !instance.isZero() : msg;
        }
    }
    ...
    public void testNegativeZeroIsInteger() {
        FloatingPointNumber zero = new HalfPrecisionNumber(Short.MIN_VALUE);
        String msg = zero.toString() + " should be integer";
        assert zero.isInteger() : msg;
    }
    ...
    @Test
    public void testNonzeroNegativeSubnormalIsNotInteger() {
        short stop = Short.MIN_VALUE + 1024;
        String msgPart = " should not be an integer";
        for (short sh = -Short.MAX_VALUE; sh < stop; sh++) {
            FloatingPointNumber instance = new HalfPrecisionNumber(sh);
            String msg = instance.toString() + msgPart;
            assert !instance.isInteger() : msg;
        }
    ...
    @Test
    public void testNonzeroPositiveSubnormalIsNotInteger() {
        String msgPart = " should not be an integer";
        for (short sh = 1; sh < 1024; sh++) {
            FloatingPointNumber instance = new HalfPrecisionNumber(sh);
            String msg = instance.toString() + msgPart;
    ...
    @Test
    public void testLowNormalsBetweenNegativeOneAndZeroAreNotIntegers() {
        short start = Short.MIN_VALUE + 1025;
        String msgPart = " should not be an integer";
        for (short sh = start; sh < -17408; sh++) {
            FloatingPointNumber instance = new HalfPrecisionNumber(sh);
            String msg = instance.toString() + msgPart;
            assert !instance.isInteger() : msg;
        }
...
//        assertEquals(result, expResult);
    ...
    @Test
    public void testNegativeFiniteIsNotInfinite() {
        String msgPart = " should not be infinite";
        short start = Short.MIN_VALUE + 1;
        for (short sh = start; sh < -1024; sh++) {
            FloatingPointNumber instance = new HalfPrecisionNumber(sh);
            String msg = instance.toString() + msgPart;
    ...
    @Test
    public void testPositiveFiniteIsNotInfinite() {
        String msgPart = " should not be infinite";
        for (short sh = 1; sh < 31744; sh++) {
            FloatingPointNumber instance = new HalfPrecisionNumber(sh);
            String msg = instance.toString() + msgPart;
    ...
    @Test
    public void testPositiveNaNIsNotInfinite() {
        short start = 31745;
        String msgPartA = " from bit pattern ";
        String msgPartB = " should not be infinite";
        for (short sh = start; sh > 0; sh++) {
